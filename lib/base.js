...
function garble_gate(type, wirein, wireout) {
  ...
  return [
    [encrypt(Wire[i][0], Wire[j][0], k, Wire[k][t[0]]), (2*(Wire[i][0]%2)) + (Wire[j][0]%2)],
    [encrypt(Wire[i][0], Wire[j][1], k, Wire[k][t[1]]), (2*(Wire[i][0]%2)) + (Wire[j][1]%2)],
    [encrypt(Wire[i][1], Wire[j][0], k, Wire[k][t[2]]), (2*(Wire[i][1]%2)) + (Wire[j][0]%2)],
    [encrypt(Wire[i][1], Wire[j][1], k, Wire[k][t[3]]), (2*(Wire[i][1]%2)) + (Wire[j][1]%2)]
