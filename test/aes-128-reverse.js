...
describe('AES128 Evaluating Server', function () {
  ...
  for (let i = 0; i < inputs.length; i++) {
    ...
    it('Input ' + i, async function () {
      // run garbling server
      const garbler = new Process('node', ['demo/server.js', '3001', 'Garbler', garblerInput, 'hex', 'aes-128-reverse.txt', 'false']);
      // run evaluator party
      const evaluator = new Process('node', ['demo/party.js', '3001', 'Evaluator', evaluatorInput, 'hex', 'aes-128-reverse.txt', 'false']);
