...
This circuit is as simple as it sounds.  Our two parties provide a total of 64 bits, and if they're all equal to zero we announce this is true, else, false.  In boolean logic and in JIGG, 1 is synonymous with true and 0 false.
...
```neptune[frame=jigg,scope=jigg,title=Circuit]
# file://circuits/bristol/compare-eq-zero-64-bit.txt
